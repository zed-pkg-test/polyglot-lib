...
/// drift controls plus internally consistent immutable TJSV workflow revisions,
/// reject mutable GitHub Actions dependencies, require explicit workflow-token
/// posture and immutable Docker/Cargo Git identities, fail closed on unknown
/// ORES runtime TOML names, enforce credential/public-argv separation plus
/// canonical flags2env provenance, apply bounded peer-authority runtime
